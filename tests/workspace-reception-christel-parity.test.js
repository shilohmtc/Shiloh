...
const EXPECTED_CHRISTEL_CAPABILITIES = [
  ...
  'booking:update', 'loyalty:view', 'loyalty:redeem', 'service:pricing', 'appointment:couples:discount', 'staff:services:view',
  'services:view', 'services:manage', 'services:create', 'forms:view', 'schedule:manage',
