...
const BOOKING_POLICY_TEXT = [
  ...
  `Under ${DEPOSIT_RULES.partialNoticeHours} hours, same-day cancellation or no-show: up to ${percentText(basisPointsPercent(DEPOSIT_RULES.lateForfeitBasisPoints))}% of the booking deposit may be forfeited.`,
  'Rescheduling keeps the existing booking payment/deposit record.',
  '',
