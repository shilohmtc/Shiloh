...
function qualifyingServices(catalogue = [], minimumBookingValue = 450) {
...
function renderMyShilohWelcomeVoucherBooking({ number, catalogue = [], minimumBookingValue = 450 } = {}) {
  const minimum = Number(minimumBookingValue) || 450;
  const eligible = qualifyingServices(catalogue, minimum);
