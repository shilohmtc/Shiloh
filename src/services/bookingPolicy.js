...
const POLICY_TEXT = [
  ...
  "",
  "*Booking Deposit*",
  "A 50% booking deposit is required to secure appointments at Shiloh. Treatments provided by Marietjie are excluded from the deposit requirement. The deposit forms part of the treatment price; it is not an extra fee.",
  "",
  "*Cancellations & Rescheduling*",
  "Please give at least 48 hours' notice when cancelling or rescheduling. With 48 hours or more notice, the deposit can move with a rescheduled booking without a cancellation penalty. With 24–48 hours notice, 50% of the booking deposit may be forfeited. With less than 24 hours notice, a same-day cancellation, or a no-show, the full booking deposit may be forfeited. Any refund or credit is handled against Shiloh's verified payment record.",
  "",
