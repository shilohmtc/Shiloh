...
.welcome-offer{background:linear-gradient(90deg,#354f42,#496354);color:#fff;border-bottom:1px solid rgba(255,255,255,.16)}.welcome-offer .shell{display:flex;align-items:center;justify-content:center;gap:18px;min-height:54px;padding-block:8px}.welcome-offer__copy{display:flex;align-items:baseline;gap:10px}.welcome-offer strong{font-family:Georgia,"Times New Roman",serif;font-size:20px}.welcome-offer span{font-size:13px;color:#f4efe6}.welcome-offer a{padding:8px 13px;border-radius:999px;background:#fff;color:var(--deep);font-size:12px;font-weight:900;text-decoration:none;white-space:nowrap}
@media(max-width:900px){.home-hero-grid,.story{grid-template-columns:1fr}.client-portal-card{grid-template-columns:1fr;align-items:start}.hero-visual{min-height:340px}.grid,.fact-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.contact-panel{grid-template-columns:1fr}}
...
function renderContact() {
  return layout({
    ...
    currentPath: '/contact',
    body: `<main id="main-content"><section class="page-hero"><div class="shell"><div class="eyebrow">Contact</div><h1>Come find Shiloh in Heidelberg.</h1><p class="lede">For service selection and appointment availability, use our booking journey. Your chosen service goes with you when you continue.</p></div></section><section class="section alt"><div class="shell contact-panel"><article class="card"><div class="eyebrow">Visit</div><h2>37 Jacobs Street</h2><p>Heidelberg, Gauteng, South Africa</p></article><article class="card"><div class="eyebrow">Email</div><h2 class="contact-email"><a href="mailto:info@shilohmtc.co.za">info@shilohmtc.co.za</a></h2><p>Email us for general enquiries and follow-ups.</p></article><article class="card"><div class="eyebrow">Appointments</div><h2>Ready to book?</h2><p>See current services and prices, then continue with Shiloh to check availability.</p><a class="button primary" href="/book">View services &amp; book</a></article></div></section></main>`,
  });
}
