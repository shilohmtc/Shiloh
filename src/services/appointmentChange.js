...
function cancellationTerms(appointment, now = new Date()){
  return cancellationPolicyNotice({
    startsAt: appointment?.starts_at,
    practitioners: appointment?.staff_name,
    now,
  });
}
function rescheduleTerms(){return reschedulePolicyNotice();}
