...
function renderSiteFooter() {
  return `<footer class="site-footer"><div class="site-footer-row"><div><strong>${PUBLIC_BRAND_NAME}</strong><p>Personal massage and aesthetic services in Heidelberg.</p></div><div><b>Visit</b><p>37 Jacobs Street<br>Heidelberg, Gauteng</p></div><div><b>Appointments</b><p><a href="/book">View services and book</a><br><a href="/my-shiloh/">Open My Shiloh</a><br><a href="/privacy">Privacy policy</a><br>Availability is confirmed when Shiloh completes your booking.</p></div></div></footer>`;
}
