...
|---|---|---|---|
| MY-SHILOH-AI-BACKBONE | Client Experience / Shiloh AI | 🔵 ACTIVE | Phase 1 authenticated CRM V2 client context + shared experience orchestrator is VERIFIED LIVE under PR #1037 / `49b7e046...`. Current controlled unit is Phase 2: authenticated in-app Shiloh conversation, reusing the existing Shiloh/OpenAI pipeline with session-owned client context, isolated conversation memory, no browser transcript persistence and no domain mutation tools. Booking/forms/payment/scheduling authorities remain canonical. |n ratified in `docs/MY-SHILOH-AI-BACKBONE-ROADMAP-2026-09-18.md`: WhatsApp is the front door, My Shiloh is the client's home, and Shiloh is the orchestration backbone. Current controlled unit is authenticated CRM V2 client context + one shared experience orchestrator consumed by Home, Bookings and Shiloh suggestions. Domain services remain booking/forms/payment/scheduling authority; no separate My Shiloh business logic or second AI brain. |
